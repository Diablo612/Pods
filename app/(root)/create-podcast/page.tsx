...
import GenerateThumnails from "@/components/GenerateThumnails"
...
const voiceCategories = ['alloy', 'shimmer', 'echo','fable', 'onyx'];
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col gap-2.5">
              ...
              <FormControl>
                <Input className="input-class focus-visible:ring-offset-orange-1"  placeholder="Pods" {...field} />
              </FormControl>
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col gap-2.5">
              ...
              <FormControl>
                <Textarea className="input-class focus-visible:ring-offset-orange-1"  placeholder="Describe your thoughts..." {...field} />
              </FormControl>
              <FormMessage className="text-white-1"/>
            </FormItem>
          )}
